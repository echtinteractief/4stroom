...
function bones_login_css() {
	wp_enqueue_style( 'bones_login_css', get_template_directory_uri() . '/library/style/css/login.css', false );
}
...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://echtinteractief.nl" target="_blank">Echt Interactief!</a></span>', 'bonestheme' );
}
